...
function imgFormat(id, options, rowObject){
    ...
    filterColValue=filterColValue.replace(/"/g,"\'"); // Замена ковычек
...
jQuery('#jqReportcol'+col).jqGrid({
    ...
    datatype: "local",
    colNames:['Дата гос.регистрации МИ','Кол-во','Перейти'],
    colModel:[
        {name:'col'+col,index:'col'+col, align:'center', width:250, searchoptions:{sopt:['eq','bw','bn','cn','nc','ew','en']}},
